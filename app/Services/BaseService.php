...
abstract class BaseService implements BaseServiceInterface
{
     ...
     * @inheritDoc
     */
    public function setRelations(array|string $relations = []): self
    {
        $this->repository->setRelations(is_array($relations) ? $relations : [$relations]);
    ...
    {
        $this->repository->setCounts($counts);
     ...
     * @inheritDoc
     */
    public function forUser(int $user_id = 0): self
    {
        $this->repository->forUser(\Auth::id());
